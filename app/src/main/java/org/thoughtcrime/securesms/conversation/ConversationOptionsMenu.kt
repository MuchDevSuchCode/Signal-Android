...
internal object ConversationOptionsMenu {
  ...
  class Provider(
    ...
    override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
      ...
      if (recipient.isGroup || recipient.isSelf || !SignalStore.settings.isConversationDeleteForBothEnabled) {
    ...
    override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
      when (menuItem.itemId) {
        ...
        R.id.menu_delete_chat_for_both -> callback.handleDeleteConversationForBoth()
        R.id.edittext_bold,
  ...
  interface Callback {
    ...
    fun handleDeleteConversationForBoth()
