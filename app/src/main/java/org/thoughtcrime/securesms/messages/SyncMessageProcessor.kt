...
object SyncMessageProcessor {
  ...
  private fun handleSynchronizeSentExpirationUpdate(sent: Sent, sideEffect: Boolean = false): Long {
    ...
    if (sent.message?.expireTimerVersion == null) {
      ...
      if (!SignalStore.settings.isHideExpireTimerUpdatesEnabled) {
      ...
      if (sent.message!!.expireTimerDuration != recipient.expiresInSeconds.seconds && !SignalStore.settings.isHideExpireTimerUpdatesEnabled) {
