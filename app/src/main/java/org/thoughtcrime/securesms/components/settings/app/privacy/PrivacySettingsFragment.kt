...
class PrivacySettingsFragment : DSLSettingsFragment(R.string.preferences__privacy) {
  ...
  private fun getConfiguration(state: PrivacySettingsState): DSLConfiguration {
    return configure {
      ...
      switchPref(
        title = DSLSettingsText.from(R.string.preferences__hide_deleted_messages),
        summary = DSLSettingsText.from(R.string.preferences__hide_deleted_messages_summary),
        isChecked = state.hideDeletedMessages,
        onClick = {
          viewModel.setHideDeletedMessages(!state.hideDeletedMessages)
        }
      )

      switchPref(
        title = DSLSettingsText.from(R.string.preferences__delete_chat_for_both),
        summary = DSLSettingsText.from(R.string.preferences__delete_chat_for_both_summary),
        isChecked = state.conversationDeleteForBoth,
        onClick = {
          viewModel.setConversationDeleteForBoth(!state.conversationDeleteForBoth)
        }
      )
      ...
      switchPref(
        title = DSLSettingsText.from(R.string.preferences__hide_expire_timer_updates),
        summary = DSLSettingsText.from(R.string.preferences__hide_expire_timer_updates_summary),
        isChecked = state.hideExpireTimerUpdates,
        onClick = {
          viewModel.setHideExpireTimerUpdates(!state.hideExpireTimerUpdates)
        }
      )
