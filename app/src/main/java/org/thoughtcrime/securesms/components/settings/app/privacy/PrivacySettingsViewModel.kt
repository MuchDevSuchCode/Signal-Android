...
class PrivacySettingsViewModel(
  ...
  fun setHideDeletedMessages(enabled: Boolean) {
    SignalStore.settings.setHideDeletedMessages(enabled)
    refresh()
  }

  fun setHideExpireTimerUpdates(enabled: Boolean) {
    SignalStore.settings.setHideExpireTimerUpdates(enabled)
    refresh()
  }

  fun setConversationDeleteForBoth(enabled: Boolean) {
    SignalStore.settings.setConversationDeleteForBoth(enabled)
    refresh()
  }
