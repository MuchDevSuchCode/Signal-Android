...
class SignalServiceDataMessage private constructor(
  ...
  val conversationDelete: Optional<ConversationDelete>
) {
  ...
  class Builder {
    ...
    private var conversationDelete: ConversationDelete? = null
    ...
    fun withConversationDelete(conversationDelete: ConversationDelete?): Builder {
      this.conversationDelete = conversationDelete
      return this
    }
    ...
    fun build(): SignalServiceDataMessage {
      ...
      return SignalServiceDataMessage(
        ...
        conversationDelete = conversationDelete.asOptional()
      )
    }
  }
  ...
  /** NON-UPSTREAM. Asks the recipient to delete the entire 1:1 conversation with the sender. */
  data class ConversationDelete(val requestedAtTimestamp: Long)
